...
class FinanceApp(ctk.CTk):
    ...
    def _build_sidebar(self):
        ...
        ctk.CTkLabel(bar, text='FinEase', font=(FONT_SERIF, 26, 'bold'), text_color=COLORS['accent']).pack(pady=(28, 24), padx=24, anchor='w')
    ...
    def build_home_page(self):
        ...
        ctk.CTkLabel(page, text='Welcome back.', font=(FONT, 28, 'bold'), text_color=COLORS['text']).pack(anchor='w')
        ctk.CTkLabel(page, text="Here's a snapshot of your family's money this month.", font=(FONT, 15), text_color=COLORS['text_soft']).pack(anchor='w', pady=(2, 24))
    ...
    def send_chat(self):
        ...
        context = f'Monthly income: {db.get_monthly_income():.0f}, total spent: {db.get_total_spending():.0f}, savings: {db.get_savings():.0f}, surplus: {db.get_monthly_surplus():.0f}'
